# Cold Email Sequences — Insurance Agent Recruitment

## Important Notes
- Send from cold domains ONLY (never tpglife.com)
- Signature: David Price, Insurance Industry Leader
- {firstName} = agent's first name from NAIC data
- {state} = their licensed state
- {carrier} = their current carrier (single-carrier agents only)
- Unsubscribe link required in every email (Smartlead handles this)

---

## SEQUENCE A: New Licensees (0 Appointments)

**Target:** Agents with `is_new_licensee = true` and `appointments_count = 0`
**Timing:** 5 emails over 10 days
**Angle:** They just got licensed, haven't committed to a carrier yet. Be the first to reach them with value.

---

### Email A1 — Day 0
**Subject lines (A/B test):**
- Congrats on your {state} insurance license!
- Just saw you got licensed in {state}
- Welcome to the insurance industry, {firstName}
...
### Email A2 — Day 2
**Subject lines:**
- The carrier decision most new agents get wrong
- Don't sign with a carrier until you read this
...
### Email A3 — Day 5
**Subject lines:**
- How a new agent wrote $50K AP in their first year
- {firstName}, this agent's first-year results might surprise you
...
### Email A4 — Day 7
**Subject lines:**
- Free training this week for new life agents
- {firstName} — invite to our agent community
...
## SEQUENCE B: Single-Carrier Agents

**Target:** Agents with `appointments_count = 1`
**Timing:** 5 emails over 14 days
**Angle:** They're committed to one carrier. Show them what they might be missing without bashing their current company.

---

### Email B1 — Day 0
**Subject lines:**
- Quick question about your {state} book of business
- {firstName}, curious about something
...
### Email B2 — Day 3
**Subject lines:**
- The commission gap most {state} agents don't know about
- What your carrier isn't telling you about comp
...
### Email B3 — Day 7
**Subject lines:**
- How agents in {state} are 3x-ing their income
- The switch that changed everything for this agent
...
### Email B4 — Day 10
**Subject lines:**
- Free training for {state} life agents
- You're invited, {firstName}

**Body:**
Hi {firstName},

I run a community of life insurance agents — we do trainings, share wins, and help each other grow. Over 500 agents across the country.
